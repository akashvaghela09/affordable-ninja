...
const Reviews = () => {
    ...
    return (
        <div className='w-10/12 rounded-lg px-14 pt-5 bg-slate-100 drop-shadow-lg mb-14'>
            ...
            <div className='relative h-72 flex justify-center items-center'>
                ...
                </button>
                {
                    ...
                    <Fade direction={direction}>
                        <div className='flex flex-col justify-start items-center w-80 h-72'>
                            <div className='flex flex-col justify-center items-center'>
                                <div className='bg-blue-500 text-slate-100 rounded-lg p-4'>{singleReview.desc}</div>
